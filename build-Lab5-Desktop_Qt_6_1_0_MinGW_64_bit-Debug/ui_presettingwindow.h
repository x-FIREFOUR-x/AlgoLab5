...
public:
    ...
    void setupUi(QMainWindow *PresettingWindow)
    {
        ...
        frameTypeGame->setGeometry(QRect(20, 20, 270, 61));
        ...
        label_2->setGeometry(QRect(24, 5, 221, 20));
        ...
        radioButtonPCFirst->setGeometry(QRect(150, 30, 111, 20));
        ...
        frameDifficulty->setGeometry(QRect(20, 170, 270, 60));
        ...
        radioButtonHard->setGeometry(QRect(190, 30, 81, 20));
